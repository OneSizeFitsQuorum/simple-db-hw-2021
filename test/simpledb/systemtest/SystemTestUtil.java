...
public class SystemTestUtil {
  ...
  /**
   * Checks if the sequence represents a quadratic sequence (approximately) ret[0] is true if the
   * sequence is quadratic ret[1] is the common difference of the sequence if ret[0] is true.
   *
   * @param sequence
   * @return ret[0] = true if sequence is qudratic(or sub-quadratic or linear), ret[1] = the
   * coefficient of n^2
   */
  ...
  /**
   * Checks if the sequence represents an arithmetic sequence (approximately) ret[0] is true if the
   * sequence is linear ret[1] is the common difference of the sequence if ret[0] is true.
   *
   * @param sequence
  ...
  /**
   * Checks if the sequence represents approximately a fixed sequence (c,c,c,c,..) ret[0] is true if
   * the sequence is linear ret[1] is the constant of the sequence if ret[0] is true.
   *
   * @param sequence
