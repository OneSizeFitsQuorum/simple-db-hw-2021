...
/**
 * A PlanCache is a helper class that can be used to store the best way to order a given set of
 * joins
 */
public class PlanCache {
   ...
   * new cost is less than any previously added cost -- simply adds or replaces an existing plan for
   * the specified join set
   *
