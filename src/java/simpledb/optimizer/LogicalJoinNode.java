...
public class LogicalJoinNode {
  ...
  /**
   * The first table to join (may be null). It's the alias of the table (if no alias, the true table
   * name)
   */
  public String t1Alias;

  /**
   * The second table to join (may be null).  It's the alias of the table, (if no alias, the true
   * table name).
   */
  public String t2Alias;

  /**
   * The name of the field in t1 to join with. It's the pure name of a field, rather that
   * alias.field.
   */
  ...
  public boolean equals(Object o) {
    ...
    return (j2.t1Alias.equals(t1Alias) || j2.t1Alias.equals(t2Alias)) && (j2.t2Alias.equals(t1Alias)
