...
/**
 * A LogicalSubplanJoinNode represens the state needed of a join of a table to a subplan in a
 * LogicalQueryPlan -- inherits state from {@link LogicalJoinNode}; t2 and f2 should always be null
 */
public class LogicalSubplanJoinNode extends LogicalJoinNode {
  ...
  public LogicalSubplanJoinNode(String table1, String joinField1, OpIterator sp,
      Predicate.Op pred) {
    t1Alias = table1;
