...
public class StringHistogram {
   ...
   * <p>
   * Our implementation is written in terms of an IntHistogram by converting each String to an
   * integer.
   *
  ...
  /**
   * Convert a string to an integer, with the property that if the return value(s1) < return
   * value(s2), then s1 < s2
   */
  ...
  /**
   * Estimate the selectivity (as a double between 0 and 1) of the specified predicate over the
   * specified string
   *
