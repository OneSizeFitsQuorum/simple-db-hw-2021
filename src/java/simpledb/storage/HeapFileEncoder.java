...
/**
 * HeapFileEncoder reads a comma delimited text file or accepts an array of tuples and converts it
 * to pages of binary data in the appropriate format for simpledb heap pages Pages are padded out to
 * a specified length, and written consecutive in a data file.
 */
...
public class HeapFileEncoder {
   ...
   *
   * @param tuples     the tuples - a list of tuples, each represented by a list of integers that
   *                   are the field values for that tuple.
   ...
   * @see HeapFile
   */
  public static void convert(List<List<Integer>> tuples, File outFile, int npagebytes,
  ...
  /**
   * Convert the specified input text file into a binary page file. <br> Assume format of the input
   * file is (note that only integer fields are supported):<br> int,...,int\n<br> int,...,int\n<br>
   * ...<br> where each row represents a tuple.<br>
   * <p>
   * The format of the output file will be as specified in HeapPage and HeapFile.
   *
   ...
   * @throws IOException if the input/output file can't be opened or a malformed input line is
   *                     encountered
   * @see HeapPage
   * @see HeapFile
   */
